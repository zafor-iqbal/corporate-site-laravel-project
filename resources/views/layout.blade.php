                    ...
                    <div class="container-fluid">
                        <div class="col-auto col-xl-3 col-lg-2 me-lg-0 me-auto">
                            <a class="navbar-brand" href="{{'/'}}">
                                <img src="{{asset('images/demo-corporate-logo-black.png')}}" data-at2x="{{asset('images/demo-corporate-logo-black@2x.png')}}" alt="" class="default-logo">
                                <img src="{{asset('images/demo-corporate-logo-black.png')}}" data-at2x="{{asset('images/demo-corporate-logo-black@2x.png')}}" alt="" class="alt-logo">
                                <img src="{{asset('images/demo-corporate-logo-black.png')}}" data-at2x="{{asset('images/demo-corporate-logo-black@2x.png')}}" alt="" class="mobile-logo">
                            </a>
                        </div>
